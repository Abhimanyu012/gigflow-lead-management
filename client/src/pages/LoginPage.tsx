      ...
      <div className="hidden lg:flex flex-col flex-1 bg-teal-950 p-12 justify-between relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-lg pb-12">
          <h2 className="text-4xl font-bold text-white mb-6 leading-tight">
            The smartest way to close deals.
          </h2>
          <p className="text-teal-200/80 text-lg">
            GigFlow gives you the intelligence and speed you need to manage leads seamlessly. Log in to access your command center.
          </p>
        </div>
      </div>
        ...
        <div className="w-full max-w-sm mx-auto">
          <div className="mb-8">
            ...
            <p className="text-sm text-[var(--text-muted)]">
              ...
              <Link to="/register" className="font-semibold text-[var(--accent)] hover:underline transition-all">
                Create one
              </Link>
            </p>
          </div>
